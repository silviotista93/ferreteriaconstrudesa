	...
	public function process_checkout() {
		try {
			...
			if ( WC()->cart->is_empty() ) {
				...
				throw new Exception( sprintf( __( 'Sorry, your session has expired. <a href="%s" class="wc-backward">Regresar a la tienda/a>', 'woocommerce' ), esc_url( wc_get_page_permalink( 'shop' ) ) ) );
			}
