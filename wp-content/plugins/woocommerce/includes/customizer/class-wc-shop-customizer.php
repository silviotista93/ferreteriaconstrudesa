	...
	public function add_checkout_section( $wp_customize ) {
		...
		$wp_customize->add_setting(
			...
			array(
				...
				'default'           => sprintf( __( 'Sus datos personales se utilizarán para procesar su pedido, respaldar su experiencia en este sitio web y para otros fines descritos en nuestro %s.', 'woocommerce' ), '[privacy_policy]' ),
				'type'              => 'option',
				'capability'        => 'manage_woocommerce',
				'sanitize_callback' => 'wp_kses_post',
				'transport'         => 'postMessage',
