		...
		wp_send_json(
			array(
				'fragments' => apply_filters(
					...
					array(
						'form.woocommerce-checkout' => '<div class="woocommerce-error">' . __( 'Sorry, your session has expired.', 'woocommerce' ) . ' <a href="' . esc_url( wc_get_page_permalink( 'shop' ) ) . '" class="wc-backward">' . __( 'Regresar a la tienda', 'woocommerce' ) . '</a></div>',
					)
				),
			)
		);
