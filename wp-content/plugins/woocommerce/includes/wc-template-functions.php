...
function wc_get_privacy_policy_text( $type = '' ) {
	...
	switch ( $type ) {
		case 'checkout':
			...
			$text = get_option( 'woocommerce_checkout_privacy_policy_text', sprintf( __( 'Sus datos personales se utilizarán para procesar su pedido, respaldar su experiencia en este sitio web y para otros fines descritos en nuestro%s.', 'woocommerce' ), '[privacy_policy]' ) );
			break;
		case 'registration':
			/* translators: %s privacy policy page name and link */
