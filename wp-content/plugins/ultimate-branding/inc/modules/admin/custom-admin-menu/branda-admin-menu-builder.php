...
class Branda_Admin_Menu_Builder {
	...
	private function print_submenu_item_markup( $submenu_item_id, $submenu_item_settings, $menu_item_slug, $first ) {
		...
		$class = $this->get_submenu_class_attribute( $submenu_item_id, $submenu_item_settings, $menu_item_slug, $first, (boolean) $image );
	...
	private function is_native( $item_settings ) {
		return (boolean) $this->get_menu_item_setting( $item_settings, 'is_native' );
	}
