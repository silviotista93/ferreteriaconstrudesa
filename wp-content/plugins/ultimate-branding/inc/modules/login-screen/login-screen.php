	...
	class Branda_Login_Screen extends Branda_Helper {
		...
		public function reset_section( $success, $option_name, $section ) {
			...
			if ( !empty( $value['theme']['id'] ) ) {
				...
				$new_data = isset( $theme_data[ $section ] ) ? $theme_data[ $section ] : [];
		...
		protected function set_options() {
			...
			$options = array(
				...
				'content' => array(
					...
					'show-as' => 'accordion',
					'fields' => $this->get_options_fields( 'content', array(
						'language',
						'logo',
						'message',
						'form',
				...
				'design' => array(
					...
					'show-as' => 'accordion',
					'fields' => $this->get_options_fields( 'design', array(
						'logo',
						'background',
						'message',
						'form',
				...
				'colors' => array(
					...
					'show-as' => 'accordion',
					'fields' => $this->get_options_fields( 'colors', array(
						'background',
						'form',
						'error_messages',
						'links_below_form',
