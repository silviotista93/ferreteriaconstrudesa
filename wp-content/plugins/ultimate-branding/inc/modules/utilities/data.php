	...
	class Branda_Data extends Branda_Helper {
				...
				'subsites' => array(
					...
					'fields' => array(
						'button' => array(
							...
							'data' => array(
								'a11y-dialog-show' => $this->get_name( 'confirm-delete-subsites' ),
							),
		...
		public function ajax_delete_subsites_data() {
			...
			if ( empty( $site ) ) {
				...
				$html .= $this->sui_notice( __( 'Successfully deleted data from all the subsites.', 'ub' ), 'success' );
				$args = array(
					'offset' => 'end',
					'html' => $html,
				);
