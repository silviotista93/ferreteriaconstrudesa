...
<div class="sui-upgrade-page">
	<div class="sui-upgrade-page-header">
		<div class="sui-upgrade-page__container">
			<div class="sui-upgrade-page-header__content">
				...
				<a href="https://premium.wpmudev.org/project/ultimate-branding/?utm_source=branda&utm_medium=plugin&utm_campaign=branda_propage_topbutton" class="sui-button sui-button-lg sui-button-purple" target="_blank">
	...
	<div class="sui-upgrade-page__container">
		<div class="sui-upgrade-page-features__items">
			<div class="sui-upgrade-page-features__item">
				...
				<h3><?php esc_html_e( 'White label plugin branding', 'ub' ); ?></h3>
				<p><?php esc_html_e( 'We love our superhero branding, but we know it\'s not for everyone. With a Pro membership, you can remove our superhero branding and replace it with your own.', 'ub' ); ?></p>
			</div>
			<div class="sui-upgrade-page-features__item">
			...
			<div class="sui-upgrade-page-features__item">
				...
				<h3><?php esc_html_e( 'Dedicated WordPress Hosting - 3 sites for FREE', 'ub' ); ?></h3>
				<p><?php esc_html_e( 'Every member gets up to 3 sites for free on our fully dedicated and fully managed WordPress Hosting. Every hosted site includes nightly backups, SSL certificate, Staging, CDN, painless migration, multiple data centers, and much more.', 'ub' ); ?></p>
			</div>
			<div class="sui-upgrade-page-features__item">
	...
	<div class="sui-upgrade-page-cta">
		<div class="sui-upgrade-page-cta__inner">
			...
			<button onclick="window.open('https://premium.wpmudev.org/project/ultimate-branding/?utm_source=branda&utm_medium=plugin&utm_campaign=branda_propage_bottombutton')" class="sui-button sui-button-lg sui-button-purple" target="_blank">
			...
			<a href="https://premium.wpmudev.org/project/ultimate-branding/?utm_source=branda&utm_medium=plugin&utm_campaign=branda_propage_bottombutton" target="_blank">
